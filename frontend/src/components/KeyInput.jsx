...
const KeyInput = ({ labelText, assignedKey, setAssignedKey, accidental }) => {
  ...
  return (
    <div class ="field">
      <div class="control custom-margin-1">
        ...
        <h2 class="subtitle is-1 is-size-2-mobile has-text-info has-text-weight-bold">{assignedKeyDisplay}</h2>

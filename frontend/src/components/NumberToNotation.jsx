...
const NumberToNotation = ({ wordDocument, setWordDocument, accidental, setAccidental, assignedKey, setAssignedKey, instant=false }) => {
  ...
  useEffect(() => {
    ...
    let cleanedChart = cleanChart(newArray, scaleDict, true)
    let newScale = createNewScale(accidental, scaleDict, assignedKey, true)
    let convertedChart = convertChart(cleanedChart, scaleDict, newScale, true)
  ...
  const handleSubmit = async (event) => {
    ...
    return (
      <form onSubmit={handleSubmit}>
          <KeyInput labelText="Translate to Key:" assignedKey={assignedKey} setAssignedKey={setAssignedKey} accidental={accidental} instant={instant}/>

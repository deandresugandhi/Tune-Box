    ...
    return (
        <div class="hero-foot">
            <nav class="tabs is-fullwidth">
                <ul>
                    <li><NavLinkContainer text="Chord Translator" path="/tools/chord-translator" className="tab-item cyan-tab"/></li>
                    <li><NavLinkContainer text="Chord Transposer" path="/tools/chord-transposer" className="tab-item pink-tab"/></li>
